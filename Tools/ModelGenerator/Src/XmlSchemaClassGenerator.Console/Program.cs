...
namespace XmlSchemaClassGenerator.Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //-v -n=""="CAFE.Core.Integration" -k=AnnotationItem -ct="System.Collections.Generic.IList`1" ..\..\..\..\cafe.xsd
            //-v -n=""="CAFE.DAL.Models" -k=AnnotationItem -f  -ct="System.Collections.Generic.IList`1"..\..\..\..\cafe.xsd
            //-v -n=""="CAFE.Web.Models" -k=AnnotationItemModel -m -ct="System.Collections.Generic.IList`1" ..\..\..\..\cafe.xsd
...
{TYPE} can be i[nt], l[ong], or d[ecimal].", v => {
                ...
                { "k|rootname=", "the class name of root element. If empty it will be default", v => rootClassName = v},
                { "y|aliases=", "the path of file aliases. If empty it will be default", v => aliasesPath = v},
                { "m|viewmodel", "generate ASP.NET MVC Model compatible classes", v => viewModel = v != null}
            };
            ...
            if(!string.IsNullOrEmpty(aliasesPath))
                generator.SetAliases(aliasesPath);
            ...
            if (generator.EntityFramework || generator.ViewModel)
            {
                generator.GenerateDesignerCategoryAttribute = false;
                generator.GenerateSerializableAttribute = false;
                generator.DataAnnotationMode = DataAnnotationMode.All;
