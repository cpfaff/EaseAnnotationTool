(function () {
    ...
    angular
        ...
        .component('filesList', {
            ...
            controller: ['FilesProvider', '$scope', '$mdDialog', 'NgTableParams',
              function (FilesProvider, $scope, $mdDialog, NgTableParams) {
                  ...
                  $scope.CreateAIWithFiles = function (event, type) {
                      if (type == 1) {
                  ...
                  $scope.checkFile = function (file) {
                      var ind = $scope.selected.indexOf(file);
                      if (ind == -1) {
