...
function GridListDirective($interpolate, $mdConstant, $mdGridLayout, $mdMedia) {
  ...
  function postLink(scope, element, attrs, ctrl) {
     ...
     * @returns {AnnotationObject} Map of CSS properties to be applied to the style element. Will define
...
function GridLayoutFactory($mdUtil) {
  ...
  function GridLayout(colCount, tileSpans) {
      ...
      return self = {
         ...
         * signature:
         *
         *    function({grid: {element: JQLite, style: AnnotationObject}, tiles: Array<{element: JQLite, style: AnnotationObject}>)
         */
