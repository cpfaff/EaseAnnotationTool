...
(function() {
   ...
   * @param {AnnotationObject} event Scope event object passed by the calendar.
...
(function() {
  ...
  function CalendarMonthBodyCtrl($element, $$mdDateUtil, $mdDateLocale) {
    ...
    /** @type {AnnotationObject} Reference to the month view. */
    this.monthCtrl = null;

    /** @type {AnnotationObject} Reference to the calendar. */
...
(function() {
  ...
  function CalendarYearBodyCtrl($element, $$mdDateUtil, $mdDateLocale) {
    ...
    /** @type {AnnotationObject} Reference to the year view. */
    this.yearCtrl = null;
...
(function() {
   ...
   * @param {AnnotationObject=} ng-model-options Allows tuning of the way in which `ng-model` is being updated. Also allows
   ...
   * @param {AnnotationObject} mdInputContainer Instance of the mdInputContainer controller.
   * @param {AnnotationObject} inputDirective Config for Angular's `input` directive.
   */
