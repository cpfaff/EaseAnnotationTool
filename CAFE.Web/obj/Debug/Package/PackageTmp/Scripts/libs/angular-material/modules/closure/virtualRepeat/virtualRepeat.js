...
function VirtualRepeatController($scope, $element, $attrs, $browser, $document, $rootScope,
   ...
   * @type {AnnotationObject<number, !VirtualRepeatController.Block}
   */
  this.blocks = {};
 ...
 * @return {!Array|!AnnotationObject} An array or array-like object for iteration.
 */
...
function VirtualRepeatModelArrayLike(model) {
  if (!angular.isFunction(model.getItemAtIndex) ||
    ...
    throw Error('When md-on-demand is enabled, the AnnotationObject passed to md-virtual-repeat must implement ' +
