(function() {
    ...
    angular
        ...
        .component('outgoingRequests', {
            ...
            controller: ['outgoingRequestsProvider', '$scope', '$mdDialog',
              function (outgoingRequestsProvider, $scope, $mdDialog) {
                  ...
                  {
                      var description = "You requested an access for following items: " + request.resourcesNames.join();
        ...
        angular.
        module('outgoing-requests.outgoing-requests-list').
        controller('messagesController', function (outgoingRequestsProvider, $scope, $mdDialog, messages, subject, conversationId, requestId, userName, reloadFunction, description) {
                'use strict';
