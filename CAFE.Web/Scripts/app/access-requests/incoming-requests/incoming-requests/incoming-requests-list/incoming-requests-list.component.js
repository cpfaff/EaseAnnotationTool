(function () {
            ...
            controller: ['IncomingRequestsProvider', '$scope', '$mdDialog',
              function (IncomingRequestsProvider, $scope, $mdDialog) {
                  ...
                  $scope.showMessages = function (event, request) {
                      var description = "User " + request.requester + " is requesting an access for following items: " + request.resourcesNames.join();
    ...
    angular.
        module('incoming-requests.incoming-requests-list').
        controller('messagesController', function (IncomingRequestsProvider, $scope, $mdDialog, messages, subject, conversationId, requestId, userName, reloadFunction, description) {
            'use strict';
