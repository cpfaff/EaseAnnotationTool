intellisense.annotate(jQuery, {
  ...
  'fn.extend': function() {
    ...
    ///   <param name="object" type="AnnotationObject">An object to merge onto the jQuery prototype.</param>
    ///   <returns type="AnnotationObject" />
    /// </signature>
  },
  'get': function() {
  ...
  'map': function() {
    ...
    /// <signature>
    ///   <summary>Translate all items in an array or object to new array of items.</summary>
    ///   <param name="arrayOrObject" type="">The Array or AnnotationObject to translate.</param>
